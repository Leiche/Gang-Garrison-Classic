// receive and inthttp://ajf.me/gg2/warpath.pngerpret the server's message(s)
    ...
    switch(readbyte(0)) {
        ...
        case PLAYER_SPAWN:
            ...
            break;
              ...
              /* GGC FUßBALL */
              case GREIFEN_FUSSBALL:
                  receiveCompleteMessage(global.serverSocket,1,0);
                  player = ds_list_find_value(global.players, readbyte(0));
                  doEventGreifenFussball(player);
                  break;
                          
              case PUNKTEN_FUSSBALL:
                  receiveCompleteMessage(global.serverSocket,1,0);
                  player = ds_list_find_value(global.players, readbyte(0));
                  doEventPunktenFussball(player);
                  break;
                  
              case FALLENLASSEN_FUSSBALL:
                  receiveCompleteMessage(global.serverSocket,1,0);
                  player = ds_list_find_value(global.players, readbyte(0));
                  if player.object != -1 {
                    with player.object event_user(15); 
                    }
                  break;
              /* END GGC */
              ...
              case ESCORT_KILLED:
                  receiveCompleteMessage(global.serverSocket,1,0);
                  player = ds_list_find_value(global.players, readbyte(0));
                  doEventEscortKilled(player);
                  break;
                  
              case ESCORT_REACHEDTARGET:
                  receiveCompleteMessage(global.serverSocket,1,0);
                  player = ds_list_find_value(global.players, readbyte(0));
